...
- semantic types: uuid, email, url, ip_address, phone, postal_code, zip_code, ssn, ein,
  routing_number, iban, bic (alias swift_code), iso_currency, currency, duration, percentage
